...
#include<mynteye_pointcloud/synchronizedImage.h>
...
class managementClass{
    private:
        ...
        mynteye_pointcloud::synchronizedImage syncImg;
        //送信データ
    ...
    public:
        ...
        //--センサーデータ受信
        void subscribeData();
        void callback(const mynteye_pointcloud::synchronizedImage::ConstPtr& imageMsg);
        //--データ重複チェック
        void checkDuplication(const mynteye_pointcloud::synchronizedImage::ConstPtr& imageMsg);
        //データ送信
        ...
        void delayTime();
        void culcPastTime();
        void culcDifTime(const mynteye_pointcloud::synchronizedImage::ConstPtr& imageMsg);
