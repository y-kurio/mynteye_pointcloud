...
#include <mynteye_pointcloud/MaskImageData.h>
// msg
...
// #include <mynteye_pointcloud/convCamDataConfig.h>
//クラスの定義
class convCamDataClass{
    ...
    protected:
        mynteye_pointcloud::SensorMapData smd;
        mynteye_pointcloud::MaskImageData mid;
