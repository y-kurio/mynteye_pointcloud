...
#include <mynteye_pointcloud/ClusterData.h>
...
class PointCloudClass{
    ...
    private:
        ...
        mynteye_pointcloud::PointCloudData cloud,cloudfromimage;
        //クラスタリング
        mynteye_pointcloud::ClusterData cluster, cluster_nondup;
        //送信データ
        ...
        EXTRACT_XMIN = -std::numeric_limits<double>::infinity(), 
