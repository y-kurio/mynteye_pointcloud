#include<mynteye_pointcloud/convCamData.h>
	...
	
{
	...
	//publisher
    pubConv= nhPub1.advertise<mynteye_pointcloud::SensorMapData>("cameraMapData", 1);
	//マスク画像
    pubMask= nhPub2.advertise<mynteye_pointcloud::MaskImageData>("maskImageData", 1);
	// lanchファイルの読み込み
	setLaunchParam();
