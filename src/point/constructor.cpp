...
pointClass::pointClass()
{
	...
	closest_point_pub_ = nh.advertise<mynteye_pointcloud::pointData>("/Cluster_closest_point", 1);
	// most_closest_point_pub_ = nh.advertise<geometry_msgs::Point>("/Cluster_Most_closest_point", 1);
